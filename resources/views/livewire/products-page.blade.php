          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="font-semibold">{{Number::currency($price_range)}}</div>
                <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="50000" value="100" step="100">
                ...
                <div class="border border-gray-300 dark:border-gray-700">
                  <div class="relative bg-gray-200">
                    <a href="/products/{{$product->slug}}" class="">
                      ...
                      <img src="{{ asset('storage/' . $product->image[0]) }}" alt="{{ $product->name }}" class="w-full h-56 object-contain bg-white">
                      @else
                      <img src="{{ asset('storage/default-image.jpg') }}" alt="Default Image" class="w-full h-56 object-cover">
                      @endif
                    </a>
                  </div>
                  <div class="p-3 ">
