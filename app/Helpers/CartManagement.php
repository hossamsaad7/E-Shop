...
class CartManagement{
    ...
    static public function addItemToCart($product_id){
        ...
        if($existing_item !== null){
            ...
            $cart_items[$existing_item]['total_price'] = $cart_items[$existing_item]['quantity'] * $cart_items[$existing_item]['unit_amount'];
        }
        else {
    ...
    // add cart items to coolie
    static public function addCartItemsToCookie($cart_items){
        Cookie::queue('cart_item', json_encode($cart_items), 60 * 24 * 30);
    }
    
    // clear cart items from coolie
    static public function clearCartItems(){
        Cookie::queue(Cookie::forget('cart_items'));
    }

    // get all cart items from coolie
